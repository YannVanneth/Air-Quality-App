...
class ZH07(BaseSensor):
    ...
    def __init__(self, port: str, sensor_id: str = "ZH07_001",
    ...
    def connect(self) -> bool:
        if self.status == SensorStatus.READY:  # FIX: Added colon here
            return True
        ...
        try:
            ...
            # Sensor requires 30s warm-up
            self.status = SensorStatus.WARMING_UP
            self.logger.info("Warming up sensor (30 seconds)...")
            time.sleep(30)
    ...
    def read_data(self) -> Optional[SensorReading]:
        ...
        try:
            ...
            time.sleep(1.1)  # Match sensor output interval
